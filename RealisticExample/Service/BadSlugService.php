...
/**
 * Class BadSlugService
 * @package IgorRinkovec\UnitExample\RealisticExample\Service
 */
class BadSlugService implements Slugify
{

    /**
     * Converts any text to a URL friendly string - but this implementation is flawed.
     *
     * @param string $text
     * @return string
     */
